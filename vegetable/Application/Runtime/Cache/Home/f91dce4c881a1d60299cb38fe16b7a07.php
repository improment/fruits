...
<div class="Bread_crumbs">
 <div class="Inside_pages clearfix">
   <div class="left">当前位置：<a href="/Public/#">首页</a>&gt;<a href="/Public/#">素菜馆</a></div>
 ...
 <DIV class="left_style">
   ...
   <div class="ranking">
    ...
    <ul class="ranking_list">
     ...
     <a href="/Public/#" class="img"> <img src="/Public/images/product_img_17.png" width="100px" height="100px" /></a>
     <p class="ranking_name">浦江特产绿豌豆天然无污染</p>
     <p class="price"><b>￥</b>12.54</p>
     <p><a href="/Public/#">立即查看< </a></p>
     </li>
     <li class="">
    ...
    <ul class="list_style">
     <li class="clearfix">
       <div class="product_lists clearfix">
        <a href="/Public/#" class="Collect"></a>
        <a href="/Public/#"><img src="/Public/images/product_img_17.png" /></a>
        <p class="title_p_name">浦江多汁红提</p>
        <p class="title_Profile">绿色有机天然无污染</p>
        <p class="price"><b>￥</b>13.5</p>
        <p class="btn_style"><a href="/index.php/Home/Xiangqing/index" class="buy_btn"></a><a href="/index.php/Home/Xiangqing/index" class="Join_btn"></a></p>
        </div>
       </li>
        <li class="clearfix">
       <div class="product_lists clearfix">
